...
export default function AddTweet() {
	...
	return (
		<div className="flex gap-3 p-5 border-neutral-400 border-b">
			<div className="relative size-10 rounded-md overflow-hidden">
				<UserCircleIcon className="text-gray-500" />
			</div>
			<form action={dispatch} className="flex flex-col w-3/5 items-start justify-center gap-2 *:rounded-md">
				<FormInput
					name="tweet"
					type="text"
